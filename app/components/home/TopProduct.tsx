        ...
        {topProducts.map((product) => (
          ...
          >
            ...
            <div className="relative aspect-square bg-gray-50">
              ...
              <span className="absolute bottom-3 right-3 bg-red-500 text-white text-[11px] font-medium px-2 py-0.5 rounded-full">
                {product.discount}
              </span>
            </div>
            ...
            <div className="p-4">
              ...
              <h3 className="text-sm font-medium text-gray-900 mt-1 line-clamp-2 group-hover:text-orange-500 transition-colors">
                {product.name}
              </h3>
